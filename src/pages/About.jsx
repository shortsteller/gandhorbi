...
export const About = () => {
  ...
  return (
    <div className="fade-in" style={{ paddingTop: '100px', backgroundColor: 'var(--bg-warm-linen)' }}>
      ...
      <section className="section-padding" style={{ borderBottom: '1px solid var(--border-subtle)' }}>
        <div className="container" style={{ textAlign: 'center', maxWidth: '850px' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: 1.15, marginTop: '0.5rem', marginBottom: '1.5rem' }}>
        ...
        <div className="container">
          <div style={{
            ...
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '2.5rem', marginTop: '4px', marginBottom: '1.2rem' }}>
              ...
              <p style={{ color: 'var(--text-warm-grey)', fontSize: '1.05rem', lineHeight: 1.8 }}>
                Simultaneously, in the red soil villages of Bankura and Purba Bardhaman, metal smiths practiced Dokra—a 4,000-year-old lost-wax bronze casting technique unchanged since the Indus Valley Civilization.
              </p>
            </div>
